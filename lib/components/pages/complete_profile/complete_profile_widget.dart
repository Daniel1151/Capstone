...
class CompleteProfileWidget extends StatefulWidget {
  const CompleteProfileWidget({
    super.key,
    required this.completeProfileParam,
  });

  final DocumentReference? completeProfileParam;
                          ...
                          children: [
                            Align(
                              ...
                              child: FlutterFlowRadioButton(
                                ...
                                radioButtonColor: Color(0xFF21CBEB),
                            ...
                            return FFButtonWidget(
                              onPressed: () async {
                                await buttonLoginUsersRecord.reference
                                  ...
                                  photoUrl: buttonLoginUsersRecord.photoUrl,
                                ));
